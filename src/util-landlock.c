 ...
 * subdirectories rooted at this path. Intended for modules such as file-store
 * that need to move files from a staging directory into the final tree.
 * Should be used only on directories fully owned by the caller.
 *
